...
const Vault_Addr = "0xf24a7ad7F30bfF30903F2E97f33c7d9802931Ab4";
...
async function main() {
  ...
  console.log("Calling setTotalHarvestFee - 20% For Strategy :>>>>", stratAddr);
  let tx = await strategyExtraI.setTotalHarvestFee(2000);
  console.log(`Tx: ${tx.hash}`);
  await tx.wait();
