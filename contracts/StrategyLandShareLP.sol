...
interface IOmnifarmFarm {
    ...
    function _userInfo(address user) external view returns (uint256, uint256);
}

contract StrategyLandShareLP is StratManager, FeeManager, GasThrottler {
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) = IOmnifarmFarm(pool)._userInfo(address(this));
        return _amount;
    }
