...
contract StrategyEllipsisBtcPool is StratManager, FeeManager, GasThrottler {
    ...
    address public constant want = address(0x2a435Ecb3fcC0E316492Dc1cdd62d0F189be5640);
    ...
    address public constant poolLp = address(0x2477fB288c5b4118315714ad3c7Fd7CC69b00bf9);
    uint8 public constant poolId = 3;
    ...
    constructor(
        ...
        IERC20(btcb).safeApprove(poolLp, uint256(-1));
    }
